...
/**
 * JProgressBar with pattern background.
 */
public class PatternProgressBar extends JProgressBar {
	...
	/**
	 * Create a normal JProgressBar.
	 */
	public PatternProgressBar(){
		super();
	}
	
	/**
	 * Create a new PatternProgressBar Object.
	 * @param image the pattern image of the ProgressBar
	 */
